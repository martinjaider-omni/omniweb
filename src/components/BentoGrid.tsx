      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          ...
          <div className="md:col-span-2 bg-white rounded-2xl border border-slate-200 p-8 shadow-sm flex flex-col justify-between overflow-hidden relative group hover:shadow-md transition-shadow">
            ...
            <div className="absolute right-8 bottom-8 z-10 bg-white p-4 rounded-lg shadow-lg border border-slate-100 max-w-[200px]">
               <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs">POS</div>
                  <div className="h-px flex-1 bg-slate-300"></div>
                  <div className="w-8 h-8 rounded-full bg-slate-900 flex items-center justify-center text-white text-xs">API</div>
               </div>
               <div className="text-center mt-2 text-xs font-mono text-slate-500">Sync Complete</div>
            </div>
          </div>

          {/* Tall Card */}
          <div className="md:row-span-2 bg-slate-900 text-white rounded-2xl p-8 shadow-sm flex flex-col relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> Push Notifications</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> Location Alerts</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> Automatic Updates</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div> No App Store Fees</li>
              </ul>
            </div>
